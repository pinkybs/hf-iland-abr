 ...
 */
class Bll_Island_Task_Achievement_T3008 extends Bll_Abstract implements Bll_Island_Task_Interface
{
    /**
     * check user task
     *
    ...
    public function check($uid, $taskId)
    {
    	...
    	//$levelInfo = $dalLevel->getIslandLevelInfo($userInfo['island_level']);
    	$levelInfo = Bll_Cache_Island::getIslandLevelInfo($userInfo['island_level']);
    	
		//island visitor
		if ( $levelInfo['visitor_count'] < 100) {
