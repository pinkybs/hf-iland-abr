 ...
 */
define('MONGO_CONNECTION', 'mongodb://10.245.227.111:27017');
...
class moadminModel {
     ...
     * @return array
     */
    public function listRows($collection, $pageIndex = 1, $pageSize = 100) {
    ...
    public function __construct() {
        ...
        if (isset($_GET['collection']) && $action != 'listCollections' && method_exists(self::$model, $action)) {
            if ($action == 'listRows') {
                ...
                $this->mongo[$action] = self::$model->$action($_GET['collection'], $pageIndex, $pageSize);              
            } else {
