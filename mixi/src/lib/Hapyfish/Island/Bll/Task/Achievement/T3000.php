...
class Hapyfish_Island_Bll_Task_Achievement_T3000 implements Hapyfish_Island_Bll_Task_Interface
{
    /**
     * check user task
     *
    ...
    public function check($uid, $taskId)
    {
        ...
        $titleInfo = Hapyfish_Island_Cache_Task::getTitleById($taskInfo['title']);
