...
class Hapyfish_Island_Bll_Feed
{
    ...
    public static function insertIslandMinifeed($feed)
    {
        ...
        Hapyfish_Island_Cache_Counter::incNewMiniFeedCount($feed['uid']);
    }
    ...
    public static function batchInsertMinifeed($feeds)
    {
		...
		//update user feed status
		Hapyfish_Island_Cache_Counter::incNewMiniFeedCount($feeds[0]['uid'], count($feeds));
    }
   ...
   /**
    ...
    public static function getFeed($uid, $pageIndex, $pageSize)
    {
        ...
        //update user feed status
        Hapyfish_Island_Cache_Counter::clearNewMiniFeedCount($uid);
    ...
    protected static function getFeedTemplateInfo($app_id, $template_id)
    {
        ...
        $template_info = Hapyfish_Island_Cache_FeedTemplate::getInfo($app_id, $template_id);
