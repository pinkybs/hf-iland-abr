...
//mixi point
require_once "osapiPointUrl.php";
require_once "osapiPointItem.php";
require_once "osapiPointStatus.php";
require_once "osapiPoint.php";
require_once 'osapiPointResult.php';
//mixi school
require_once "osapiSchool.php";
