...
class Hapyfish2_Island_Event_Bll_InviteFlow
{
    ...
    public static function gain($uid, $step, $time = null)
    {
    	...
    	if ($step == 1) {
			...
			$compensation->setItem(37521, 1);
			$title = 'Chúc mừng bạn nhận túi quà "mời nhận thưởng" thứ 1!';
    	} else if ($step == 2) {
			//邀请3名新玩家，奖励兔爷54321
			...
			$title = 'Chúc mừng bạn nhận túi quà "mời nhận thưởng" thứ 2!';
    	} else if ($step == 3) {
    		...
    		//$goldnum = 20;
			//$compensation->setGold($goldnum, 0);
			$compensation->setItem(72631, 1);
    		$title = 'Chúc mừng bạn nhận túi quà "mời nhận thưởng" thứ 3!';
    	} else if ($step == 4) {
			...
			//$goldnum = 10;
    		//$compensation->setGold($goldnum, 0);
    		$compensation->setItem(70131, 1);
    		$title = 'Chúc mừng bạn nhận túi quà "mời nhận thưởng" thứ 4!';
    	}
