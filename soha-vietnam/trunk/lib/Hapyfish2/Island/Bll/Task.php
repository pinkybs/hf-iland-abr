        ...
        if (is_file(LIB_DIR . '/' . $implFile)) {
            ...
            if ($result['status'] == 1) {
                ...
                if ($coinChange > 0) {
                    ...
                    //$sendStr = '<font color="#FF0000">' . $coinChange . 'Vàng</font> ';
                }

                if ($expChange > 0) {
                	$sendStr .= '<font color="#FF0000">' . $expChange . LANG_PLATFORM_BASE_TXT_04. '</font> ';
                    //$sendStr .= '<font color="#FF0000">' . $expChange . 'kinh nghiệm</font> ';
                }
                ...
                if ($taskType == 2) {
	                ...
	                if ( $coinChange > 0 ) {
	                    ...
	                    //$daySend = '<font color="#FF0000">' . $coinChange . 'Vàng</font> ';
	                }

	                if ( $expChange > 0 ) {
	                	$daySend .= '<font color="#FF0000">' . $expChange . LANG_PLATFORM_BASE_TXT_04.'</font> ';
	                    //$daySend .= '<font color="#FF0000">' . $expChange . 'kinh nghiệm</font> ';
	                }
    ...
    public static function checkTask($uid, $taskId)
    {
    	...
    	try {
            ...
            $result['islandLevelUp'] = $levelUp['islandLevelUp'];
                ...
                if ($expChange > 0) {
                    $sendStr .= '<font color="#FF0000">' . $expChange . 'Exp</font> ';
                }
                if ($cardName) {
                    $sendStr .= '<font color="#9F01A0">' . $cardName . '</font>';
                }
                ...
                if ( $expChange > 0 ) {
                    $daySend .= '<font color="#FF0000">' . $expChange . 'Exp</font> ';
                }
