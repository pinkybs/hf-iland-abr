...
class Hapyfish2_Platform_Dal_User
{
    ...
    public function getInfo($uid)
    {
        ...
        $sql = "SELECT uid,puid,name,email,figureurl,gender,create_time FROM $tbname WHERE uid=:uid";
    ...
    public function add($user)
    {
        ...
        $sql = "INSERT INTO $tbname (uid, puid, name, email, gender, figureurl, create_time) VALUES"
