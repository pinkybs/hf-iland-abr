...
define('LOG_DIR', '/home/admin/website/island_soha_vietnam/logs');
...
define('APP_ID', '1');
define('APP_KEY', 'f59691447230992e39ae3e2ef9ce0c67');
define('APP_SECRET', 'f41635956309617845dcb1f3fc59fa51');
define('APP_NAME', 'island_vn');

define('DATABASE_NODE_NUM', 4);
define('MEMCACHED_NODE_NUM', 10);

define('HOST', 'http://devvietnam.happyfish001.com');
define('STATIC_HOST', 'http://static.happyfishgame.com/soha_vietnam');
